...
public class ProductInfoActionNew
  extends Action
{
  private static final Log log = LogFactory.getLog(ProductInfoActionNew.class);
    ...
    throws Exception
  {
    ...
    Object[] plist = pr.getRecords() == null ? new Object[0] : pr
      .getRecords();
