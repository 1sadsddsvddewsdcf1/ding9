...
public class CommSyn
{
  ...
  public int doSyn() {//throws HttpException, IOException {
    ...
    try {
      ...
      System.err.println("doSyn,error,date="+new java.util.Date()+",host="+ client.getHostConfiguration().getHost()+",url="+this.url
    		  +","+ex.getMessage());
      //2014-03-29 暂时取消 ex.printStackTrace();
    }
    finally {
    	if (get != null)  //2014-03-29 增加
