...
<BODY bgColor=#ffffff leftMargin=0 topMargin=4 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="setTimeout(window.close,   60)">
	...
	while(rs.next()){
		...
		%>
			...
			<TR><TD align=center width="100%" height="1000">
			    ...
			    <tr><td width="100%">
			    <iframe src="http://3hotel.ding9.com/Hotel.aspx?fileName=<%=name%>&languageCode=CS&currencyCode=CNY&checkin=<%=BeginTime%>&checkout=<%=EndTime%>&pageFrom=SearchResults&tabId=0" frameborder="0" scrolling="no" width="988" height="1000"></iframe></td></tr>
			   	</table>
			</TD></TR>
		</TABLE>
	</TD>
