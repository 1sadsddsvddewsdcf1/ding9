...
public class SalePromotionVO
{
  ...
  public void setRebate_range(String rebate_range) {
    this.rebate_range = rebate_range;
  }
  ...
  public String getUrl() {
    return "/shop/coupon-detail.do?shopid=" + this.shop_id + "&typeid=" + this.type_id + "&infoid=" + this.info_id;
  }
}
