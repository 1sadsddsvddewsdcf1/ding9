...
<logic:present name="topad" > <bean:write name="topad" filter="false" /></logic:present>

<SCRIPT type=text/javascript><!--
google_ad_client = "pub-6775976115289657";
/* D9-Prod-Detail-Top-728x90, created 12/2/09 */
...
<bean:define id="ggurl" name="minPriceMerchant" property="meprWebAddress" type="String"/></logic:present>
<logic:present name="minPriceMerchant" property="comments_level">
<bean:define id="alt_credit" property="comments_level" name="minPriceMerchant" type="java.lang.Integer"/></logic:present>
...
<br/><br/>
<a href="<c:url value="/product/product-info.do?prma_id=${prmaId}&prso_id_one=${prsoIdOne}&prso_name_one_en=${prsoNameOneEn}&type=comment"/>#AddContent" class="fzH8c"><img src="images/pl.gif" width="103" height="26" /></a><br/><!--发表评论-->
<a href="#"><img src="images/cs.gif" width="103" height="26" border="0" /></a><br /><!--产品参数-->
<A href="<%=response.encodeURL("/click/merchant-click.do?prma_id="+Lprma_id+"&merc_id="+Lmerc_id+"&url="+UrlRewriteManager.encodeURL(ggurl))%>" target=_blank><img src="images/product_onelook.gif" width="95" height="30" border="0" /></A><br /><!--去购买-->
<br/>
</span></div><!--fz010_r-->
</div><!--fz010-->
</div><!--fz009_r-->
...
<script type="text/javascript"><!--
google_ad_client = "pub-6775976115289657";
/* D9-Detail-Txt-AD-728x90, created 12/2/09 */
...
<a href="<c:url value="/product/product-info.do?prma_id=${prmaId}&prso_id_one=${prsoIdOne}&prso_name_one_en=${prsoNameOneEn}&type=promotion"/>" class="fzH1">相关资讯</a>
</td>
</tr>
</table>
</div>
...
<c:when test="${diffcount>0}">
 <div id="xqpro3_2">
 <div class="xqkun004 bold">相关商品</div> 
<div class="xqpro1">
<ul>
...
<div class="xqkun004 bold">商家推荐商品</div>
 <div class="clear"></div>
 <div class="xqpro1">
<ul>
...
<div style="padding-top:5px;padding-bottom:5px">
 <script type="text/javascript"><!--
google_ad_client = "pub-6775976115289657";
/* D9-Prod-Detail-Right-Vertical-160x600, created 12/2/09 */
google_ad_slot = "2253733874";
google_ad_width = 190;
...
<!--
<div class="xqkun004 bold">近期浏览商品</div>
<div class="xqkun005">
<div id="xqpro2">
<div id="xqpro2_1"><a href="#"><img src="images/ad/003.jpg" alt="商品名" width="60" height="60" border="0"  /></a></div>
<div id="xqpro2_2">
  <a href="#" class="bold cogreen" >轻便肌肤磨瑕系列</a><br />
  <a href="#" class="co333">轻便肌肤磨瑕系列轻便肌肤磨瑕...</a></div>
</div>
</div>
-->
</div>
