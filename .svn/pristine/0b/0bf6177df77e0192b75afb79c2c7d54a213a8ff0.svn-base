...
public class RecommendMerchantInfo
{
  ...
  private int syus_id;
  private String mere_time = Character.FieldDateToString(new Date(), "yyyy-MM-dd HH:mm:ss");
  ...
  public int getInfo_id() { return this.info_id; }
  ...
  public String getMere_name() { return this.mere_name; }
  
  public void setMere_name(String mere_name) {
    this.mere_name = mere_name;
  }
  
  public String getMere_time() { return this.mere_time; }
  
  public void setMere_time(String mere_time) {
    this.mere_time = mere_time;
  }
  
  public int getRecom_type() { return this.recom_type; }
