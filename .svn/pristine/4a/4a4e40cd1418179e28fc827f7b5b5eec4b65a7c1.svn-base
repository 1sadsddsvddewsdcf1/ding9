  ...
  public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain)
  {
    try {
      ...
      if (log.isWarnEnabled()) {
        log.warn("****");
        log.warn("Filter filepath :" + fileuri + req.getQueryString() + "  " + System.currentTimeMillis());
        log.warn(UrlRewriteManager.dynamic2static(fileuri.toString()));
        log.warn(UrlRewriteManager.static2dynamic(UrlRewriteManager.dynamic2static(fileuri.toString())));
      }
