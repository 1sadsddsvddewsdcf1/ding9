...
<TR><TD width=780 align=center valign="top" height="94">
		<script type="text/javascript"><!--
		google_ad_client = "pub-2083833315482406";
		/* 728x90, 创建于 08-3-5 */
		google_ad_slot = "2546982311";
		google_ad_width = 728;
		google_ad_height = 90;
		//-->
		</script>
...
<TR><TD vAlign=top align=center bgColor=#ffffff width=828>
		<TABLE cellSpacing=0 cellPadding=0 width=100% align=center border=0>
			<TR><TD vAlign=middle align=center bgColor=#ffffff width=828 height=45> 
                <table width="828" height="45" border="0" cellpadding="0" cellspacing="0">
                <TR><TD background="../Local%20Settings/Temp/images/sony-2_5_45h.jpg" align=left  height="40">
				    <font size=3><b>&nbsp;&nbsp;&nbsp;&nbsp; 全球酒店搜索：</b></font>
				    </TD></TR>
				<TR>
				<TD width="828">
				 	<font size=2> &nbsp;&nbsp;点击下面结果里的<img src="images/select_cs.gif">或<img src="images/select.gif">按钮到相关酒店预订网站即可。<br>&nbsp;&nbsp;如果下面没有出现搜索结果和 “选择”按钮，请点击下面结果里的城市名称重新选择酒店进行价格比较。<br>&nbsp;&nbsp;请耐心等待页面完全显示,数据loading 
	...
	while(rs.next()){
		...
		%>
			...
			<TR><TD align=center width="100%" height="1500">
			    <table cellpadding="0" cellspacing="0" border="0" width="100%">
			    <tr><td width="100%">
			    <iframe src="http://1hotel.ding9.com/Hotel.aspx?fileName=<%=name%>&languageCode=CS&currencyCode=CNY&checkin=<%=BeginTime%>&checkout=<%=EndTime%>&pageFrom=SearchResults&tabId=0" frameborder="0" scrolling="no" width="840" height="1500"></iframe></td></tr>
			   	</table>
			</TD></TR>
		</TABLE>
	</TD>
