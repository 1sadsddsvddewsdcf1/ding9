	...
	while(rs.next()){
		...
		%>
			...
			<TR><TD align=center width="100%" height="1000">
			    ...
			    <tr><td width="100%">
			    <iframe src="http://3hotel.ding9.com/Hotel.aspx?fileName=<%=name%>&languageCode=CS&currencyCode=CNY&checkin=<%=BeginTime%>&checkout=<%=EndTime%>&pageFrom=SearchResults&tabId=0" frameborder="0" scrolling="no" width="828" height="1000"></iframe></td></tr>
			   	</table>
			</TD></TR>
		</TABLE>
	</TD>
