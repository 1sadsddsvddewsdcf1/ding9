...
var tablink_idname = new Array("linkthree","anotherlink")
//Set the id names of your tabcontentareas (without a number at the end)
var tabcontent_idname = new Array("contentthree","anothercontent") 
		...
		function show(d1) 
		   ...
		   if(Number(d1))
			...
			NowFrame=d1;                //设当前显示图片
                  ...
                  {
		     if(i==NowFrame){
		       document.getElementById('div'+NowFrame).style.display ='block';   //当前图
		    ...
		    NowFrame++;
                  ...
                  theTimer=setTimeout('show()', 2500);   //设置定时器，显示下一张图片
	      }
