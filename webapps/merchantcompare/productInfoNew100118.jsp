...
<a href="http://guide.ding9.com" target="_blank"><img src="/images/ad/009.jpg" width="728" height="80" border="0" /></a>
</div>
<c:choose>
...
<span class="fzH1c"><c:out value="${pparainfo.Param_name}"/>：</span><c:out value="${pparainfo.Param_value}"/>&nbsp;&nbsp;
</c:if>
...
<br/><br/>
<a href="<c:url value="/product/product-info.do?prma_id=${prmaId}&prso_id_one=${prsoIdOne}&prso_name_one_en=${prsoNameOneEn}&type=comment"/>#AddContent" class="fzH8c">发表评论</a>
<br/><br/>
</span></div><!--fz010_r-->
</div><!--fz010-->
</div><!--fz009_r-->
...
/* 728x90, created 9/21/09 */
google_ad_slot = "8018096759";
google_ad_width = 730;
google_ad_height = 90;
//-->
</script>
...
<div id="xqpro3">
<div id="xqpro3_1">
<a href="http://guide.ding9.com"><img src="/images/ad/011.jpg" width="224" height="224" /></a>
</div>
<c:choose>
...
<div style="padding-top:5px;padding-bottom:5px">
 <script type="text/javascript"><!--
google_ad_client = "pub-6775976115289657";
/* 160x600, created 10/14/09 */
google_ad_slot = "3105287715";
google_ad_width = 160;
