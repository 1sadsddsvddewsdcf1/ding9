...
//count=0;
//}else
if(ProvinceCode=="33"||ProvinceCode=="34"||ProvinceCode=="35"){
selCity.options[0]=new Option("-=无=-","0000");
count=1;
}else if(ProvinceCode=="01"||ProvinceCode=="02"||ProvinceCode=="03"||ProvinceCode=="04"||ProvinceCode=="05"){
selCity.options[0]=new Option("请选择区","0000");
count=1;
}else{
...
function InitCitySelect2(selProvince,selCity,provCode,cityCode){
InitCitySelect(selProvince,selCity)
for(i=0;i<selProvince.length;i++){
if(selProvince.options[i].value==provCode){
