...
<link href="/hotel/css3.0/tefont.css" rel="stylesheet" type="text/css">
<link href="/hotel/css3.0/te.css" rel="stylesheet" type="text/css">
...
<select name="btmprovince" id="province" class=teH1></select>
<select name="btmselectc" id="city" class=teH1></select>
<script language=javascript>InitCitySelect(document.btmsearchFormover.btmprovince,document.btmsearchFormover.btmselectc);</script>			  
<a id=pro2 style="DISPLAY: none"> <input name="cheapcard" type="text" class="teH4" value="输入关键字进行搜索" size="54" onblur=btmshowSearch(this,1) onfocus=btmshowSearch(this)></a>
<a id=pro3 style="DISPLAY: none"> <input name="promotion" type="text" class="teH4" value="输入关键字进行搜索" size="54" onblur=btmshowSearch(this,1) onfocus=btmshowSearch(this)></a>
<a id=pro4 style="DISPLAY: none"> <input name="article" type="text" class="teH4" value="输入关键字进行搜索" size="54" onblur=btmshowSearch(this,1) onfocus=btmshowSearch(this)></a>
...
<label><input name="Submit" type="submit" class="teH1" value="搜 索"></label>
</div>
<!--c04-->
<div class="con900_2">
<div class="teH1c">
<a href="http://guide.ding9.com/resume.htm" target="_blank" class="teH1c">关于我们</a> | 
<a href="http://guide.ding9.com/help.htm" target="_blank" class="teH1c">使用帮助</a> | 
<a href="http://guide.ding9.com/service.htm" target="_blank" class="teH1c">服务条款</a> | 
<a href="http://guide.ding9.com/technique.htm" target="_blank" class="teH1c">招贤纳士</a> | 
<a href="http://guide.ding9.com/contact.htm" target="_blank" class="teH1c">联系我们</a> | 
<a href="http://guide.ding9.com/merchant.htm" target="_blank" class="teH1c">商家加盟</a> | 
<a href="http://guide.ding9.com/comethod.htm" target="_blank" class="teH1c">网站合作</a> | 
<a href="http://guide.ding9.com/search.htm" target="_blank" class="teH1c">搜索竞价</a> | 
<a href="http://eshop.ding9.com" target="_blank" class="teH1c">顶九商城</a> |
<a href="http://guide.ding9.com/business.htm" target="_blank" class="teH1c">网站地图</a></div>
</div>
<div id="end002">
<div id="end002_l"></div>
<div id="end002_m">
